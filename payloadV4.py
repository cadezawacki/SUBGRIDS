...
class BaseMessage(Message):
    def __init__(self, action_str, action_int, *,
                 ...
                 user=None, fingerprint=None, session=None, username=None, displayName=None, role=None, firstName=None, lastName=None, client_ip=None, client_port=None,
        ...
        if (user is None) and _any([fingerprint, session, username, displayName, role, firstName, lastName]):
            user = User(fingerprint=fingerprint, sessionFingerprint=session, username=username, displayName=displayName, role=role, firstName=firstName, lastName=lastName, client_ip=client_ip, client_port=client_port)
